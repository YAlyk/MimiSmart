...
Коллекция скриптов для интеграции AV-оборудования с системой умного дома **MimiSmart**.  
Скрипты написаны на Bash и PHP и подключаются через исполняемые команды платформы MimiSmart (номера устройств/команд).
