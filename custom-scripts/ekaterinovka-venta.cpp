/*
{
	...
	vars:[
{name:"V0",type:"devices-list",required:true,width:900,filter:["lamp", "script"],desc:"Вытяжка",descWidth:100},
...
{name:"L5",type:"devices-list",required:false,width:900,filter:["lamp","dimer-lamp", "light-scheme"],desc:"Свет ванной",descWidth:100},
{name:"L6",type:"devices-list",required:false,width:900,filter:["lamp","dimer-lamp", "light-scheme"],desc:"Свет ванной",descWidth:100},
{name:"L7",type:"devices-list",required:false,width:900,filter:["lamp","dimer-lamp", "light-scheme"],desc:"Свет ванной",descWidth:100},
{name:"L8",type:"devices-list",required:false,width:900,filter:["lamp","dimer-lamp", "light-scheme"],desc:"Свет ванной",descWidth:100},
...
V-ID/L0, #ifdef L1 L1, #endif #ifdef L2 L2, #endif #ifdef L3 L3, #endif #ifdef L4 L4, #endif #ifdef L5 L5, #endif #ifdef L6 L6, #endif #ifdef L7 L7, #endif #ifdef L8 L8, #endif 
{
	if((opt(0)&1)==1 && ([V-ADDR.0]&1)==1)
	{
		...
		delayedCallM(START, T0);
                ...
                #ifdef L5 && ([L5.0]&1)==0 #endif
				#ifdef L6 && ([L6.0]&1)==0 #endif
				#ifdef L7 && ([L7.0]&1)==0 #endif
				#ifdef L8 && ([L8.0]&1)==0 #endif)
				&& ([V-ADDR.0]&1)==1
			)
	{
