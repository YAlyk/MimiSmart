...
V-ID/s:5
{
  if ([NEST.0]%2!=0){
    ...
    //Кондиционирование
        ...
        if( (tempAuto+200 < tempK) && i!=2 ) {i=2; k[0]=17; k[4]=0; k[1]=([NEST.1]); setStatus(COND, &k);} else 
        if( (tempAuto+180 > tempK) && i!=1 ) {i=1; k[0]=49; k[4]=0; k[1]=([NEST.1]); setStatus(COND, &k);} else
