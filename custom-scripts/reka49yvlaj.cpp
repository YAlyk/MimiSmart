...
{name:"H0",type:"devices-list",required:true,width:1000,filter:["conditioner"], desc:"Увлажнитель 0 гост]",descWidth:100},
...
{name:"B0",type:"devices-list",required:true,width:1000,filter:["lamp"], desc:"лампа 0 гост",descWidth:100},
...
{name:"B3",type:"devices-list",required:false,width:1000,filter:["lamp"],desc:"лампа 3",descWidth:100},
{name:"B4",type:"devices-list",required:false,width:1000,filter:["lamp"],desc:"лампа 4",descWidth:100},
{name:"B5",type:"devices-list",required:false,width:1000,filter:["lamp"],desc:"лампа 5",descWidth:100},
{name:"B6",type:"devices-list",required:false,width:1000,filter:["lamp"],desc:"лампа 6",descWidth:100},
...
{name:"D3",type:"devices-list",required:true,width:1000,filter:["humidity-sensor"], desc:"Датчик 3",descWidth:100},
...
#ifdef H0 V-ID/H0{if([H0.0]%2!=0 ) i[0]=1; else i[0]=0;} #endif
#ifdef H1 V-ID/H1{if([H1.0]%2!=0 ) i[1]=1; else i[1]=0;} #endif
#ifdef H2 V-ID/H2{if([H2.0]%2!=0 ) i[2]=1; else i[2]=0;} #endif
#ifdef H3 V-ID/H3{if([H3.0]%2!=0 ) i[3]=1; else i[3]=0;} #endif
#ifdef H4 V-ID/H4{if([H4.0]%2!=0 ) i[4]=1; else i[4]=0;} #endif
#ifdef H5 V-ID/H5{if([H5.0]%2!=0 ) i[5]=1; else i[5]=0;} #endif
#ifdef H6 V-ID/H6{if([H6.0]%2!=0 ) i[6]=1; else i[6]=0;} #endif