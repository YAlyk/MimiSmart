...
// на кондиционере маску скоростей сделать FF, чтобы все работали. авто = 0 скорость.
u16 fans(u16 fan){
 	if(fan>=10000) return 7;
	else if(fan>=8000) return 6;
    else if(fan>=6000) return 5;
    else if(fan>=5000) return 4;
	else if(fan>=4000) return 3;
    else if(fan>=3000) return 2;
	else if(fan>=2000) return 1;
    else if(fan>=1000) return 0;

	else if(fan==0) return 1000;
    else if(fan==1) return 2000;
    else if(fan==2) return 3000;
    else if(fan==3) return 4000;
	else if(fan==4) return 5000;
	else if(fan==5) return 6000;
    else if(fan==6) return 8000;
	else if(fan==7) return 10000;
}
