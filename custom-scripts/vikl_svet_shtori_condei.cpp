/*
{
	...
	vars:[
		...
		{name:"C02",type:"devices-list",required:false,width:800,filter:["conditioner"],desc:"Кондиционер 3",descWidth:100},
...
V-ID/V-ADDR{
	if((opt(0)&1)==1){
		...
		#ifdef C02 getStatus(C02, cond); cond[0]=cond[0]&0xFE; setStatus(C02, &cond);#endif
		// Скрипты фрамуг
