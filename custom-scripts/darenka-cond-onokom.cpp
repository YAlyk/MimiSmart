/*
{
  ...
  addItems:[
        ...
        {tag:"item", id:"%TARGET%", name:"NAME6", "sub-id":"%SUBID06%", "type":"conditioner", "t-min":"16", "t-delta":"14", "vane-ver":"0x00", "vane-hor":"0x00", "funs":"0x0F", "modes":"0x1F"}
  ],
  vars:[
        ...
        {name:"Address6",type:"number",min:"1",max:"127",required:false,defaultValue:"6",desc:"Адрес Modbus"},
...
V-ID/Cond01, Cond02, Cond03, Cond04, Cond05, Cond06{
...
V-ID/s:3 {
    if(write==0){
        ...
        else if(count==5){readhold[0]=Address6;}
