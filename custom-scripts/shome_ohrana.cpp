/*
{
  ...
  vars:[
	...
	{name:"IP1",type:"text",required:false,defaultValue:"192.168.1.100",filter:"0123456789.",desc:"IP Адрес AC3"},
    {name:"IP2",type:"text",required:false,defaultValue:"192.168.1.100",filter:"0123456789.",desc:"IP Адрес AC3"},
    {name:"IP3",type:"text",required:false,defaultValue:"192.168.1.100",filter:"0123456789.",desc:"IP Адрес AC3"},
    {name:"IP4",type:"text",required:false,defaultValue:"192.168.1.100",filter:"0123456789.",desc:"IP Адрес AC3"},
    {name:"IP5",type:"text",required:false,defaultValue:"192.168.1.100",filter:"0123456789.",desc:"IP Адрес AC3"},
    {name:"IP6",type:"text",required:false,defaultValue:"192.168.1.100",filter:"0123456789.",desc:"IP Адрес AC3"},
    {name:"IP7",type:"text",required:false,defaultValue:"192.168.1.100",filter:"0123456789.",desc:"IP Адрес AC3"},
    {name:"IP8",type:"text",required:false,defaultValue:"192.168.1.100",filter:"0123456789.",desc:"IP Адрес AC3"},
	]
}
*/
