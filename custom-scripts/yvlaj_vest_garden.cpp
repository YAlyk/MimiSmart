...
{name:"H0",type:"devices-list",required:true,width:1000,filter:["conditioner"],desc:"Увлажнитель 0 детские",descWidth:100},
...
{name:"B0",type:"devices-list",required:true,width:1000,filter:["lamp"],desc:"Кнопка 0 детские",descWidth:100},
...
{name:"D0",type:"devices-list",required:true,width:1000,filter:["humidity-sensor"],desc:"Датчик 0 детская1",descWidth:100},
...
{name:"D7",type:"devices-list",required:false,width:1000,filter:["humidity-sensor"],desc:"Датчик 7 детская2",descWidth:100},
...
V-ID/s:420
{
if( (i[0]==1) && ([H0.1]+10>[D0.1] || [H0.1]+10>[D7.1]) ) setStatus(B0, 1);
