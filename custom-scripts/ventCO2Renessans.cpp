/*
{
  ...
  [
    ...
    {name:"O05",type:"devices-list",required:false,width:600,filter:["co2-sensor"],desc:"Сенсор 5",descWidth:100},
...
V-ID/s:5
{
  if(([V-ADDR.0]&1)==1)
  {
    ...
    #ifdef O05 u16 pokazanie5=(([O05.0]*100/255)+([O05.1]*100)); #endif

    if (pokazanie0>700 #ifdef O01 || pokazanie1>700 #endif #ifdef O02 || pokazanie2>700 #endif #ifdef O03 || pokazanie3>700 #endif #ifdef O04 || pokazanie4>700 #endif #ifdef O05 || pokazanie5>700 #endif)
        {getStatus(K00, &k); k[0]==1; k[4]=3; setStatus(K00, &k);} else
    if (pokazanie0>550 #ifdef O01 || pokazanie1>550 #endif #ifdef O02 || pokazanie2>550 #endif #ifdef O03 || pokazanie3>550 #endif #ifdef O04 || pokazanie4>550 #endif #ifdef O05 || pokazanie5>700 #endif)
