/*
{
    ...
    {type:"comment",text:"Скрипты и шторы выкл",width:200, style:"color:red;"},
    {name:"U30",type:"devices-list",required:false,filter:["script","jalousie","virtual"],width:888,desc:"Скрипты"},
    {name:"U31",type:"devices-list",required:false,filter:["script","jalousie","virtual"],width:888,desc:"Скрипты"},
    {name:"U32",type:"devices-list",required:false,filter:["script","jalousie","virtual"],width:888,desc:"Скрипты"},
    {name:"U33",type:"devices-list",required:false,filter:["script","jalousie","virtual"],width:888,desc:"Скрипты"},
    {name:"U34",type:"devices-list",required:false,filter:["script","jalousie","virtual"],width:888,desc:"Скрипты"},
    {name:"U35",type:"devices-list",required:false,filter:["script","jalousie","virtual"],width:888,desc:"Скрипты"},
...
V-ID/V-ADDR
{
    if ([V-ADDR.0]==1)
    {
        ...
        #ifdef U12 if(([U12.0]&7)==1 ) setStatus(U12, 1); #endif
        #ifdef U13 if(([U13.0]&7)==1 ) setStatus(U13, 1); #endif
        #ifdef U14 if(([U14.0]&7)==1 ) setStatus(U14, 1); #endif
        #ifdef U15 if(([U15.0]&7)==1 ) setStatus(U15, 1); #endif
        #ifdef U16 if(([U16.0]&7)==1 ) setStatus(U16, 1); #endif
        #ifdef U17 if(([U17.0]&7)==1 ) setStatus(U17, 1); #endif
        #ifdef U18 if(([U18.0]&7)==1 ) setStatus(U18, 1); #endif
        #ifdef U19 if(([U19.0]&7)==1 ) setStatus(U19, 1); #endif
